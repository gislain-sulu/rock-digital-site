...
import { useSvgIds } from './useSvgIds';

export function Nodejs(props: SVGProps<SVGSVGElement>) {
  const id = useSvgIds('nodejs');

  return (
    <svg {...props} viewBox="0 0 256 292" xmlnsXlink="http://www.w3.org/1999/xlink">
      <defs>
        <linearGradient id={id('a')} x1="68.188%" x2="27.823%" y1="17.487%" y2="89.755%">
        ...
        <linearGradient id={id('c')} x1="43.277%" x2="159.245%" y1="55.169%" y2="-18.306%">
        ...
        <linearGradient id={id('f')} x1="-4.389%" x2="101.499%" y1="49.997%" y2="49.997%">
